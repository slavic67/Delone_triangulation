...
def circumcircle(tri):
	'''Функция для определения парамтеров описанной окружности вокруг треугольника'''
	try:
...
def pointInCircle(point, circle):
	'''Проверяем находится ли точка в окружности или нет'''
...
class Point():
	...
	'''Инициализация точки, точка имеет 2 координаты x и y'''
	...
	'''Функция для конвертации координат точек в строку'''
	def pointToStr(self):
		return str(self.pos())
